  ...
  theProduct: Product[] = [
    {
        ...
        details: [
            {
                name: 'Detalhes',
                description: 'Feita com algodão de peso médio em nosso ajuste exclusivo Max90, esta camiseta Premium Essentials eleva um elemento essencial do dia a dia. O tratamento de tingimento dá a cada camiseta um acabamento único.'
            },
            {
                name: 'Envios e Devoluções',
                description: 'Feita com algodão de peso médio em nosso ajuste exclusivo Max90, esta camiseta Premium Essentials eleva um elemento essencial do dia a dia. O tratamento de tingimento dá a cada camiseta um acabamento único.'
            }
        ],
        sizes: [
